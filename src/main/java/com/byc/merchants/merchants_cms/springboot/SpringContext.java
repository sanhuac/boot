...
public class SpringContext implements ApplicationContextAware, DisposableBean, ApplicationListener<ApplicationContextEvent> {
    ...
    public SpringContext() {
        log.info("SpringContext initialize completion >");
    }
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        ...
        if (SpringContext.applicationContext != null) {
            log.info("SpringContext中的ApplicationContext被覆盖, 原有ApplicationContext为:{}", SpringContext.applicationContext);
        }
    ...
    public void destroy() throws Exception {
        log.debug("清除SpringContext的ApplicationContext:{}", applicationContext);
