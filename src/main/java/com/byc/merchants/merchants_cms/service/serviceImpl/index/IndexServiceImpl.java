...
public class IndexServiceImpl implements IndexService {
    ...
    public Map<String, Object> merIndex(Integer mer_id) throws UnifiedException {
        ...
        //店铺logo
        infoMap.put("store_logo", Constant.getInstance().PIC_URL_PREFIX + mer.getStore_logo());
        //关注人数
        ...
        for (BrowHistory history : historyList) {
            history.setAvatar_url(Constant.getInstance().PIC_URL_PREFIX + history.getAvatar_url());
        }
