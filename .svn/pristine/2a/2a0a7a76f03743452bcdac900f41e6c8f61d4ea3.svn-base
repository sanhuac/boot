...
public class AddressUtils {
    ...
    public static String getAddresses(String content)
        ...
        if (returnStr != null) {
            // 处理返回的省市区信息
            Map<String, Object> contentMap = JSON.parseObject(returnStr,Map.class);
            int resultCode = (Integer) contentMap.get("code");
            if(resultCode!=0){
                return "0";
            }
            ...
            if(!"-1".equals(dataMap.get("region_id"))){
                sb.append(dataMap.get("region_id") + ",");
            }
            if(!"-1".equals(dataMap.get("city_id"))){
                sb.append(dataMap.get("city_id") + ",");
            }
            if(!"-1".equals(dataMap.get("county_id"))){
                sb.append(dataMap.get("county_id"));
            }
