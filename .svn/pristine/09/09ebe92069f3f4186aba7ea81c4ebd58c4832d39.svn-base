...
public interface SmsMapper {
    ...
    int updateUsedBySpecificCondition(@Param("newSmsStatus") int newSmsStatus,@Param("smsCode") String smsCode,
                                      @Param("userMobile") String userMobile,@Param("smsStatus") int smsStatus,@Param("smsType") int smsType);
